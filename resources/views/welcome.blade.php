...
<body>
    ...
    <div class="content">
        <img src="{{ asset('img/imgfaculdade.png') }}" alt="">
        ...
        <div class="container-noticias">
            <div class="noticias">
                ...
                <h2 class="title">DIA DA LUTA ANTIMANICOMIAL</h2>
                <p>05/02/2012</p>
        ...
        <div class="container-cursos">
            <div class="Curso">
                ...
                <h3 class="cianorte">CIANORTE</h3>
                <h2 class="cursos">Administração</h2>
                <p class="descricao">Formação profissional de alto nível, com capacidade crítica e reflexiva de suas ações e consciente de suas responsabilidades.</p>
            </div>
            <div class="Curso">
                <img src="{{ asset('img/fisio.png') }}" alt="">
                <h3 class="cianorte">CIANORTE</h3>
                <h2 class="cursos">Fisioterapia</h2>
                <p class="descricao">Formação profissional de alto nível, com capacidade crítica e reflexiva de suas ações e consciente de suas responsabilidades.</p>
            </div>
            <div class="Curso">
                <img src="{{ asset('img/ads.png') }}" alt="">
                <h3 class="cianorte">CIANORTE</h3>
                <h2 class="cursos">ADS</h2>
                <p class="descricao">Formação profissional de alto nível, com capacidade crítica e reflexiva de suas ações e consciente de suas responsabilidades.</p>
            </div>
        </div>
    </div>
